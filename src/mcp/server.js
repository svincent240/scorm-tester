...
const TOOL_META = new Map([
  ...
  ["scorm_get_console_errors", { description: "Get browser console errors/warnings from SCORM content - categorized by type (scorm_api, syntax, runtime, network)", inputSchema: { type: "object", properties: { session_id: { type: "string" }, since_ts: { type: "number" }, severity: { type: "array", items: { type: "string", enum: ["error", "warn", "info"] } } }, required: ["session_id"] } }],
